  ...
  return (
    <div>
      ...
      <div className="box text-center">
        ...
        <p className="subtitle">
          We know that customers' feedbacks are crucial for businesses. That's why we created OnSurvey. We want business owners to have the most painless experience sending mass surveys to customers.
        </p>
      </div>
